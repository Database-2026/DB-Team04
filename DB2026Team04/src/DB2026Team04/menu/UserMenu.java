package DB2026Team04.menu;

import java.util.ArrayList;
import java.util.Scanner;

import DB2026Team04.dao.UserActivityDAO;
import DB2026Team04.dao.UserContentDAO;
...
public class UserMenu {
        ...
        while (true) {
            ...
            switch (readInt()) {
                case 1 -> {
                    ...
                    int pcId = contentDAO.getPcIdByTitle(newTitle);
                    if (pcId == -1) {
                        System.out.println("❌ 존재하지 않거나 현재 시청 불가능한 콘텐츠 제목입니다. 다시 확인해 주세요.");
                        // 해당 메뉴를 종료하거나 초기 화면으로 return 시켜 트랜잭션 실행을 방지합니다.
                        return; 
                    }
                ...
                case 3 -> {
                    System.out.print("수정할 기록 ID (기록 ID는 '내 시청 기록 조회'에서 확인하실 수 있습니다.): ");
                ...
                case 4 -> {
                    System.out.print("삭제할 기록 ID (기록 ID는 '내 시청 기록 조회'에서 확인하실 수 있습니다.): ");
                    int historyId = readInt();
    ...
    private void showReviewMenu() {
        while (true) {
            ...
            System.out.println("6. 시청완료 + 리뷰 동시 작성");
            System.out.println("0. 뒤로가기");
            System.out.print("선택: ");
            ...
            switch (readInt()) {
                ...
                case 4 -> {
                    System.out.print("수정할 리뷰 ID (리뷰 ID는 '내 리뷰 조회'에서 확인하실 수 있습니다.): ");
                ...
                case 5 -> {
                    System.out.print("삭제할 리뷰 ID (리뷰 ID는 '내 리뷰 조회'에서 확인하실 수 있습니다.): ");
                    int reviewId = readInt();
